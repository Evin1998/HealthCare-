...
public class SupplementFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_supplement, container,false);

        rvProduct = v.findViewById(R.id.rv_product_supplement);
        session = new SessionManager(getActivity());
        db = new DBHelper(getActivity());

        products = Product.createSupplementProductList();
